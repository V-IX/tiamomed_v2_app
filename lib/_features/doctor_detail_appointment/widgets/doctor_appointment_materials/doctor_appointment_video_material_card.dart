                ...
                children: <Widget>[
                  SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.file(File(videoMaterial.previewImagePath), fit: BoxFit.cover),
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        FittedBox(
                          fit: BoxFit.fitWidth,
                          child: Text(
                            p.basename(videoMaterial.videoPath),
                        ...
                        Text(
                          getFileSize(videoMaterial.videoPath),
                          style: const TextStyle(
            ...
            Flexible(
              child: Transform.scale(
                ...
                child: Checkbox(
                  ...
                  value: videoMaterial.isSelected,
